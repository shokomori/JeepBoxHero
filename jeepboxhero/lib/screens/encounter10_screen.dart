// lib/screens/encounter10_screen.dart
...
class _Encounter10ScreenState extends State<Encounter10Screen> {
  ...
  void initState() {
    ...
    _updateShowContinue();
    try {
      AudioManager().playBgm('bgm_kokoy_theme.mp3', volume: 0.18, loop: true);
    } catch (_) {}
    try {
  ...
  void _startGameplay() async {
    ...
    if (result == true && mounted) {
      GameState.addToCart({
        'album': 'Cutterpillow',
        'artist': 'Eraserheads',
        'imagePath': 'assets/albums/eraserheads_cutterpillow.png',
      });
  ...
  bool _isCustomerSpeaking() {
    ...
    return speaker != null && speaker.toString().contains('Kokoy');
  }
        ...
        child: Stack(
          children: [
            ...
            AnimatedPositioned(
              ...
              child: Image.asset(
                  _isCustomerSpeaking()
                      ? 'assets/characters/kokoy_talking.png'
                      : 'assets/characters/kokoy.png',
                  fit: BoxFit.contain,
                  errorBuilder: (context, error, stackTrace) {
            ...
            if (_albumFound)
              Positioned(
                  ...
                  height: w * 0.25,
                  child: Image.asset(
                      'assets/albums/eraserheads_cutterpillow.png',
                      fit: BoxFit.contain,
                      errorBuilder: (context, error, stackTrace) {
                    return Container(
  ...
  Widget _buildDialogueOptions(double w, double h) {
    final options = [
      {'text': 'National anthem of the 90s.', 'value': 'A'},
      {'text': 'I\'ll get you that sunshine record.', 'value': 'B'},
      {'text': 'Still unbeaten, even now.', 'value': 'C'},
    ];
